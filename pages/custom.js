...
const modes = {
  classic: {
    name: "classic",
    "Time Limit Per Turn": { value: 3, description: "(Minutes) Duration each player has per turn. If 0, no time limit." },
    "Overall Time Limit": { value: 0, description: "(Minutes) Duration of the whole game. If 0, no time limit." },
  ...
  blitz: {
    name: "blitz",
    "Time Limit Per Turn": { value: 1, description: "(Minutes) Duration each player has per turn. If 0, no time limit." },
    "Overall Time Limit": { value: 0, description: "(Minutes) Duration of the whole game. If 0, no time limit." },
  ...
  custom: {
    name: "custom",
    "Time Limit Per Turn": { value: 0, description: "(Minutes) Duration each player has per turn. If 0, no time limit." },
    "Overall Time Limit": { value: 0, description: "(Minutes) Duration of the whole game. If 0, no time limit." },
    "Starting Cards": { value: 0, description: "Number of cards each player starts with." },
    "Starting Coins": { value: 0, description: "Amount of coins each player starts with." },
