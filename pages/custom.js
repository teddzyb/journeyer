...
const modes = {
  classic: {
    name: "classic",
    "Time Limit Per Turn": { value: 3, description: "" },
    "Overall Time Limit": { value: 0, description: "" },
    "Starting Cards": { value: 5, description: "" },
    "Starting Coins": { value: 0, description: "" },
    "Choices Per Turn": { value: 2, description: "" },
    "Value of Gold Coin": { value: 5, description: "" },
    "Enable White Cards": { value: true, description: "" },
  },
  blitz: {
    name: "blitz",
    "Time Limit Per Turn": { value: 1, description: "" },
    "Overall Time Limit": { value: 0, description: "" },
    "Starting Cards": { value: 0, description: "" },
    "Starting Coins": { value: 0, description: "" },
    "Choices Per Turn": { value: 2, description: "" },
    "Value of Gold Coin": { value: 0, description: "" },
    "Enable White Cards": { value: false, description: "" },
  },
  custom: {
    name: "custom",
    "Time Limit Per Turn": { value: 0, description: "" },
    "Overall Time Limit": { value: 0, description: "" },
    "Starting Cards": { value: 0, description: "" },
    "Starting Coins": { value: 0, description: "" },
    "Choices Per Turn": { value: 0, description: "" },
    "Value of Gold Coin": { value: 0, description: "" },
    "Enable White Cards": { value: false, description: "" },
  },
}
