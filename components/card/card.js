...
const Card = (props) => {
  return (
    <div
      className={`rounded-md select-none ${props.className} ${
        props.placeholder
    ...
    >
      <div
        className="flex justify-center items-center text-center card-background 
          ...
          <div className="flex flex-col w-full h-full">
            ...
            >
              <Image
                ...
                layout="responsive"
                alt=""
                className={`outline outline-offset-1 outline-black aspect-square rounded-[1px] w-fit ${
                  {
                    sm: "outline-1 h-[20px]",
                    md: "outline-1 h-[24px]",
                    lg: "outline-1 h-[28px]",
