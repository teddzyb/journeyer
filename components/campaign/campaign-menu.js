  ...
  return (
    <div className="flex flex-col grow gap-5 px-5 mt-4 py-2 scrollbar-thin scrollbar-thumb-translucent scrollbar-track-transparent">
      <div className="flex items-start gap-6 rounded-xl bg-translucent shadow-md p-6">
        <FontAwesomeIcon icon={faSkull} className="text-5xl text-teal-400 p-2" draggable="false" />
        <div className="flex flex-col justify-center gap-1">
          <div className="text-xl uppercase select-none">{props.stage.name}</div>
            ...
            <div key={index} className="flex justify-between rounded-xl bg-translucent py-4 px-6">
              ...
              <div className="flex items-center gap-4">
                {objective.rewards.silver && (
                  <div className="flex flex-col justify-center items-center gap-1 select-none -mb-1 px-1">
                    <Image src={silverCoin} width={28} height={28} alt="" draggable="false" />
                    {objective.rewards.silver}
                  </div>
                )}
                {objective.rewards.gold && (
                  <div className="flex flex-col justify-center items-center gap-1 select-none -mb-1 px-1">
                    <Image src={goldCoin} width={28} height={28} alt="" draggable="false" />
                    {objective.rewards.gold}
                  </div>
                )}
                  ...
                  <Tooltip.Provider delayDuration="25">
                    <Tooltip.Root>
                      <Tooltip.Trigger asChild>
                        <div className="flex flex-col justify-center items-center gap-1 select-none bg-translucent rounded-full p-1">
                          <Image
                      ...
                      <Tooltip.Content
                        side="right"
                        className="bg-[#0a3a37] rounded-md py-1 pt-[6px] px-3"
                      >
                        {objective.rewards.cards +
                          " random " +
                          (objective.rewards.cards > 1 ? "cards" : "card")}
