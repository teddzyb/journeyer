  ...
  return props.type !== "placeholder" ?
    (
      <ContextMenu.Root>
        ...
        <ContextMenu.Portal>
          <ContextMenu.Content className="flex flex-col gap-1 bg-[#0c4441] rounded-md pt-[10px] pb-2 px-3">
            <ContextMenu.Item className="hover:outline-none hover:text-teal-300">
              <button className="text-start w-full">Add to Friends</button>
            </ContextMenu.Item>
            <ContextMenu.Item className="hover:outline-none hover:text-teal-300">
              <button className="text-start w-full">Kick</button>
            </ContextMenu.Item>
          </ContextMenu.Content>
        </ContextMenu.Portal>
      </ContextMenu.Root>
